...
with f2:
    seasons = ["All"] + sorted(raw["SeasonLabel"].dropna().unique().tolist())
...
if game != "All":
    df_filtered = df_filtered[df_filtered["Game"] == game]
if season != "All":
    df_filtered = df_filtered[df_filtered["SeasonLabel"] == season]
if league != "All":
    df_filtered = df_filtered[df_filtered["League Name"] == league]
        ...
        with c2:
            ...
            if picks:
                ...
                if PLOTLY_OK and not plot_df.empty:
                    fig3 = px.line(plot_df, x=x_col, y="Points", color=entity_col, markers=True,
